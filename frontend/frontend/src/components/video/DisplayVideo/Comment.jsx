...
function CommentsSection() {
    ...
    const getCommentLoading = useSelector((state) => state.comment.loading.getComment)
    const createCommentLoading = useSelector((state) => state.comment.loading.createComment)
        ...
        <div className="bg-gray-800 p-4 rounded-xl">
            ...
            <div className="mt-8">

                {
                    comments.length ?
                        <>
                            {!getCommentLoading && <div className="space-y-4 ">
                                {comments?.map((c) => (
                                    <div
                                        key={c._id}
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <div onClick={() => handleClick(c._id)} className="cursor-pointer">
                            ...
                            {getCommentLoading && <BasicSpinner />}
